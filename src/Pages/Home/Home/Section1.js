...
import section2 from './../../../images/sec-2.png';
import section3 from './../../../images/sec-3.png';
...
const Section1 = () => {
    return (
        <div className="section mt-5 ">
            ...
            <div class="col">
              <div class=" h-100">
                <img src={section1} class="card-img-top images" alt="..."/>
                <div class="card-body">
                  <h5 class="card-title">Choose Pizza</h5>
                  <p class="card-text">User generated content in will have multiple touchpoints for offshoring.</p>
                </div>
            ...
            <div class="col">
              <div class=" h-100">
                <img src={section2} class="card-img-top images" alt="..."/>
                <div class="card-body">
            ...
            <div class="col">
              <div class=" h-100">
                <img src={section3} class="card-img-top images" alt="..."/>
                <div class="card-body">
